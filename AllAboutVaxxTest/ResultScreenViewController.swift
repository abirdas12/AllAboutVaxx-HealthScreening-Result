...
class ResultScreenViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if (scoring == 4) {
            ...
            HeathScreeningCheck.image = UIImage(named: "CheckMark")
            
        }
        else {
            labeling.text = "Bad Luck"
            ...
            HeathScreeningCheck.image = UIImage(named: "XMark")
    ...
    @IBOutlet weak var HeathScreeningCheck: UIImageView!
